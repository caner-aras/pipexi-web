    ...
    <DrawerPortal data-slot="drawer-portal">
      ...
      >
        <DrawerPrimitive.Popup
          ...
          className={cn(
            // Base.
            "group/drawer-popup pointer-events-auto fixed z-50 m-(--drawer-inset,0px) flex h-(--drawer-content-height) max-h-(--drawer-content-max-height,none) min-h-0 w-(--drawer-content-width,auto) transform-[translate3d(var(--translate-x,0px),var(--translate-y,0px),0)_scale(var(--stack-scale))] flex-col bg-popover text-sm text-popover-foreground transition-[transform,height,opacity,filter] duration-450 ease-[cubic-bezier(0.22,1,0.36,1)] will-change-transform outline-none select-none [interpolate-size:allow-keywords] data-[swipe-direction=down]:rounded-t-xl data-[swipe-direction=down]:border-t data-[swipe-direction=left]:rounded-xl data-[swipe-direction=left]:border-r data-[swipe-direction=right]:rounded-xl data-[swipe-direction=right]:border-l data-[swipe-direction=up]:rounded-b-xl data-[swipe-direction=up]:border-b",
            // Nested.
            ...
            // Axis: x — keep flush left/right, add top/bottom gap.
            "data-[swipe-axis=x]:top-2.5 data-[swipe-axis=x]:bottom-2.5 data-[swipe-axis=x]:h-auto data-[swipe-axis=x]:flex-row",
            // Direction: down.
