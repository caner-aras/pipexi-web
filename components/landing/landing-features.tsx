...
export function LandingFeatures() {
  return (
    <section id="features" className="py-24 sm:py-32 bg-card border-t border-border">
      <div className="mx-auto max-w-7xl px-6 md:px-8 space-y-32">
        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          <div className="space-y-6">
            ...
            <ul className="space-y-3 pt-4 text-[15px] font-bold text-foreground/80">
        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          ...
          <div className="order-1 md:order-2 space-y-6">
            <div className="inline-flex size-12 items-center justify-center rounded-2xl bg-brand/5 text-brand border border-brand/15">
